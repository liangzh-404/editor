...
1. Continue user-visible writing-flow polish after the Return-at-caret split, Backspace-at-start merge, Cmd-B same-format toggle-off, fully selected span toggle-off, and Cmd-E inline-code shortcut slices.
