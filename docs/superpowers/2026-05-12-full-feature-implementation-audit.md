...
The next concrete gaps are CloudKit remote fetch/retry/background trigger, CloudKit entitlements and live account validation, Keychain/iCloud account metadata, richer Markdown syntax coverage, result/backlink navigation polish, and advanced block UI interactions.
