...
1. Continue user-visible writing-flow polish after the Return-at-caret split, Cmd-B same-format toggle-off, fully selected span toggle-off, and Cmd-E inline-code shortcut slices.
