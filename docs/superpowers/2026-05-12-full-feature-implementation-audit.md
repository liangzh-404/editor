...
The next concrete gaps are adding UI search/backlink views, live CloudKit adapter behavior, Keychain/iCloud account metadata, richer Markdown syntax coverage, and advanced block UI interactions.
