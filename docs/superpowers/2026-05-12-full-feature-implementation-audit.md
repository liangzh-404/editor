...
1. Continue remaining inline Markdown editing polish that improves everyday writing flow, after the Cmd-B same-format toggle-off, fully selected span toggle-off, and Cmd-E inline-code shortcut slices.
