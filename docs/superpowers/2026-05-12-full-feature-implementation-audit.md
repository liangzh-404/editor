...
| verification | repository/view-model/platform/markdown/sync tests, title-editing regressions, entitlement-gated CloudKit startup regression, search/backlink navigation regressions, 750-block page regression, macOS/iOS app builds, and latest macOS app launch evidence | Partial; macOS UI automation test target exists but is blocked by local system authentication |
