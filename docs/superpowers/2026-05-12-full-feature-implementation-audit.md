...
The next concrete gaps are CloudKit remote fetch/retry/background trigger, macOS CloudKit target entitlement once Xcode account/provisioning is available, table/callout/toggle Markdown coverage, result/backlink navigation polish, and richer advanced block interactions.
