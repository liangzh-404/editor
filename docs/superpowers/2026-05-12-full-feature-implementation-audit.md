...
The next concrete gaps are CloudKit remote fetch/retry/background trigger, CloudKit entitlements and live account validation, table/callout/toggle Markdown coverage, result/backlink navigation polish, and advanced block UI interactions.
