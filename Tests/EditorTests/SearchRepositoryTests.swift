...
final class SearchRepositoryTests: XCTestCase {
    ...
    func testSearchIndexesPageTitlesBlockTextAndAttachmentFilenames() throws {
        ...
        XCTAssertTrue(try repository.search("Welcome").contains(SearchResult(entityType: "page", entityID: pageID, title: "Welcome", snippet: "Welcome")))
        XCTAssertTrue(try repository.search("Alpha").contains(SearchResult(entityType: "block", entityID: blockID, title: "Welcome", snippet: "Alpha searchable block")))
