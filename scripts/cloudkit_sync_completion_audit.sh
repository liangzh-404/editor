...
CLOUDKIT_REQUIRED_RECORD_TYPES="${CLOUDKIT_REQUIRED_RECORD_TYPES:-WorkspaceRecord NotebookRecord PageRecord DiaryPageRecord AttachmentRecord BlockRecord EditorRuntimeProbeRecord}"
